...
(() => {
        ...
        FOLDERS: {
          CHAT_FOLDER: {
            ...
            BUTTONS: {
               ...
               */
              BUTTON_NEW_CHAT: 'button[data-tooltip-content="New Chat in Project/Folder"]',
              /**
               * Must be used with the result of the BUTTONS.CONTAINER selector
               */
              BUTTON_EDIT_PROJECT_NAME: 'button[data-tooltip-content="Edit Project/Folder Name"]',
              /**
               * Must be used with the result of the BUTTONS.CONTAINER selector
               */
              BUTTON_DELETE_PROJECT_FOLDER: 'button[data-tooltip-content="Delete Project/Folder"]'
            }
          }
        }
      }
  ...
  function addEventHandlersToChatFolder(chatFolder) {
    ...
    const editFolderNameButton = buttonsContainer?.querySelector(
      SELECTORS.SIDEBAR.MIDDLE_PART.FOLDERS.CHAT_FOLDER.BUTTONS.BUTTON_EDIT_PROJECT_NAME
    );
